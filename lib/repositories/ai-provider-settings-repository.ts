...
import { aiProviderSettings } from "$lib/server/db/schema/external_modules/MoLOS-AI-Knowledge/tables";
...
const toModelsJson = (value?: string[]) =>
  JSON.stringify(Array.isArray(value) ? value : []);

const mapSettings = (
  row: typeof aiProviderSettings.$inferSelect,
): AiProviderSettings => ({
  ...row,

...
<section class="space-y-6 xl:space-y-8" in:fade={{ duration: 180 }}>
	<header class="rounded-2xl border bg-card/80 p-6 lg:p-8 xl:p-10 shadow-sm" in:fly={{ y: 12, duration: 220 }}>
		<div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
			<div class="space-y-2">
				<input
					class="w-full bg-transparent text-2xl lg:text-3xl font-semibold tracking-tight outline-none placeholder:text-muted-foreground border-b-2 border-transparent focus:border-primary transition-colors duration-200 sm:max-w-2xl lg:max-w-3xl"
			...
			<div class="flex flex-wrap items-center gap-3 sm:justify-end">
				<Button
					variant="outline"
					size="sm"
					class="rounded-full px-4 py-2 min-h-[44px] text-md font-semibold transition-all duration-200 hover:bg-muted"
	...
	<div class="grid gap-6 lg:gap-8 lg:grid-cols-[minmax(0,1fr)_380px]" in:fade={{ duration: 180 }}>
		<div class="space-y-6 xl:space-y-8">
			<section class="rounded-2xl border bg-card/80 p-6 lg:p-8 xl:p-10 shadow-sm" in:fly={{ y: 10, duration: 200 }}>
				<div class="flex items-center justify-between">
					<h3 class="text-sm lg:text-base font-semibold">Prompt content</h3>
					<span class="text-xs lg:text-sm text-muted-foreground">Main draft</span>
				</div>
				<Textarea
					class="mt-4 min-h-[420px] w-full rounded-xl border-2 border-muted bg-background p-4 text-sm focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-200"
		...
		<aside class="space-y-4 xl:space-y-5">
			...
			<div class="rounded-2xl border bg-card/80 p-5 lg:p-6 shadow-sm" in:fly={{ y: 10, duration: 200 }}>
				<h3 class="text-sm lg:text-base font-semibold">Commit</h3>
			...
			<section class="rounded-2xl border bg-card/80 p-5 lg:p-6 shadow-sm" in:fly={{ y: 10, duration: 200 }}>
				<h3 class="text-sm lg:text-base font-semibold">Version</h3>
			...
			<section class="rounded-2xl border bg-card/80 p-5 lg:p-6 shadow-sm" in:fly={{ y: 10, duration: 200 }}>
				<h3 class="text-sm lg:text-base font-semibold">Actions</h3>
